...
class ColMonthCell: ColCell {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.Label.text = "\(month[indexPath.row])".uppercased()
...
class ColDayCell: ColCell {
    ...
    var day = 0
    let week = ["Domingo","Segunda-feira","Terceira-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"]
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let Comps = comps?.weekday {
            cell.Week.text = week[Comps - 1].uppercased()
        }
